...
mongoose.connect("mongodb+srv://hoanphuoc20021208:abcdefg@createcluster.d9tdpy9.mongodb.net/travelDB?retryWrites=true&w=majority").then(function _callee() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return regeneratorRuntime.awrap(Destination.deleteMany());

        case 3:
          _context.next = 5;
          return regeneratorRuntime.awrap(Destination.insertMany([{
            id: 1,
            imgSrc: "img1.jpg",
  ...
  return console.log("❌ Lỗi seeding:", err);
});
